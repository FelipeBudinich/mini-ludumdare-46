...
(function (window) {
    ...
    gp = {
        registerGamepadEvents: function () {
            ...
            gamepad.init();
            var mapping = {
                "SELECT_BACK": ig.KEY.C,
                "START_FORWARD": ig.KEY.C,
                ...
                "FACE_3": ig.KEY.C,
                "FACE_4": ig.KEY.V,
                "LEFT_TOP_SHOULDER": ig.KEY.C,
                "LEFT_BOTTOM_SHOULDER": ig.KEY.C,
                "RIGHT_TOP_SHOULDER": ig.KEY.C,
                "RIGHT_BOTTOM_SHOULDER": ig.KEY.C
            };
