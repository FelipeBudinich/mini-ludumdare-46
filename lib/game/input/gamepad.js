...
(function (window) {
    ...
    gp = {
        registerGamepadEvents: function () {
            ...
            gamepad.init();
            var mapping = {
                "SELECT_BACK": ig.KEY.A,
                "START_FORWARD": ig.KEY.D,
                "DPAD_UP": ig.KEY.UP_ARROW,
                "DPAD_DOWN": ig.KEY.DOWN_ARROW,
                "DPAD_LEFT": ig.KEY.LEFT_ARROW,
                "DPAD_RIGHT": ig.KEY.RIGHT_ARROW,
                "FACE_1": ig.KEY.S,
                "FACE_2": ig.KEY.D,
                "FACE_3": ig.KEY.A,
                "FACE_4": ig.KEY.W,
                "LEFT_TOP_SHOULDER": ig.KEY.A,
                "LEFT_BOTTOM_SHOULDER": ig.KEY.W,
                "RIGHT_TOP_SHOULDER": ig.KEY.D,
                "RIGHT_BOTTOM_SHOULDER": ig.KEY.S
            };
            ...
            gamepad.bind(Gamepad.Event.DISCONNECTED, function (device) {
                alert('Your Gamepad is disconnected, please reconnect and press Ok', device);
            });

            gamepad.bind(Gamepad.Event.BUTTON_DOWN, function (e) {
                var evObj = document.createEvent('Event');
                evObj.initEvent('keydown', true, false);
                evObj.keyCode = mapping[e.control];
