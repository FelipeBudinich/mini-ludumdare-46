...
ig.module(
    ...
    ig.Title = ig.Game.extend({
        ...
        handleInput: function () {
            ...
            if (ig.input.pressed('action_01') || ig.input.pressed('action_02') || ig.input.pressed('action_03') || ig.input.pressed('action_04') || ig.input.pressed('up') || ig.input.pressed('down') || ig.input.pressed('left') || ig.input.pressed('right')) {
