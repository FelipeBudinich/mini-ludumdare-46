...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','game.data.music-manager','game.scenes.ingame','game.scenes.title','plugins.impact-infinite','game.levels.start','game.levels.01','game.levels.02','game.levels.03','game.levels.04','game.levels.05','game.levels.06','game.levels.07','game.levels.08','game.levels.09','game.entities.player','game.entities.anchor','game.entities.explosion','game.entities.bubble').defines(function(){'use strict';ig.launchGame=ig.Game.extend({clearColor:"#d7e894",init:function(){ig.setNocache(true);this.initInput();this.initAudio();},initAudio:function(){},initInput:function(){gp.registerGamepadEvents();ig.input.bind(ig.KEY.LEFT_ARROW,'left');ig.input.bind(ig.KEY.RIGHT_ARROW,'right');ig.input.bind(ig.KEY.UP_ARROW,'up');ig.input.bind(ig.KEY.DOWN_ARROW,'down');ig.input.bind(ig.KEY.Z,'action_01');ig.input.bind(ig.KEY.X,'action_02');ig.input.bind(ig.KEY.C,'action_03');ig.input.bind(ig.KEY.V,'action_04');},update:function(){ig.system.setGame(ig.Title);}});ig.System.scaleMode=ig.System.SCALE.CRISP;ig.main('#canvas',ig.launchGame,60,160,144,4);});